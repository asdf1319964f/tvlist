var rule = {
    title: '疯AV',
    host: 'https://airav.io/cn/?utm_source=moefuns&utm_medium=link&comesite=moefuns',
    url: 'https://airav.io/cn/list?idx=fypage&sort=fyclass',
    searchUrl: 'https://airav.io/cn/search_result?kw=**',
    searchable: 2,
    quickSearch: 0,
    headers: {
    ...
    一级: 'body&&.oneVideo&&;h5&&Text;img&&src;.fa-heart&&Text;a&&href',
    二级: '*',
