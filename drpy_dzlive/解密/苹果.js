...
globalThis.vodids = function(ids) {
	...
	let data = {
		vod_id: ids,
		vod_name: rdata.name,
		vod_remarks: '小虎斑' + rdata.updateInfo,
		vod_actor: rdata.actor,
		vod_director: rdata.director,
		vod_content: '小虎斑提醒你请勿相信任何广告——' + rdata.content,
		vod_play_from: '小虎斑蓝光',
		vod_play_url: ''
	};
	//return data; 
...
var rule = {
	...
	lazy: $js.toString(() => {
		...
		input = {
			...
			jx: 0,
			danmaku: 'http://43.242.202.175:9595/nnjsdm.php?key=789456123&id=' + '&jm=' + parts[1] + '&js=' + parts[2] + '&key=789456123'
		};
